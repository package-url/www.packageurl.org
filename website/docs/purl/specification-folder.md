...
This PURL section of the website includes the following documentation that is 
not currently included in **ECMA-427**:
...
- **PURL test overview**: Overview of PURL test groups, test types and test
  cases.
